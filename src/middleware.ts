...
const PROTECTED_PREFIXES = ['/dashboard', '/study', '/practice', '/ai-tutor', '/past-papers', '/progress', '/leaderboard', '/settings', '/mcq', '/flashcards', '/notes', '/results', '/subscription', '/bookmarks', '/library', '/doubts', '/routine', '/guess-paper', '/full-test', '/parent', '/essay-writer', '/age-counter', '/humanizer'];

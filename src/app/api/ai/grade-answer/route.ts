...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await gatewayChat({
      ...
      messages: [
        { role: 'system', content: 'You are an expert examiner for Pakistani board exams. Grade fairly based on the marking scheme. Return JSON: {"score": number, "maxScore": number, "feedback": string, "improvements": string[]}' },

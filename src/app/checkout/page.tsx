    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-md rounded-3xl border border-border bg-card p-8 text-center shadow-xl">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          Filhaal online checkout hide hai. Manual payment ke liye in numbers par amount send karein, phir screenshot
          zehra4088194@gmail.com par bhej dein. Within 1 hour your transaction will be verified:
        </p>

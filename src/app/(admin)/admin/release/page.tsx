...
export default async function AdminReleasePage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-5"><div><h1 className="text-2xl font-bold">Release Readiness</h1><p className="text-muted-foreground">Environment, database, and launch checks.</p></div><ReleaseReadiness /></div>;
}

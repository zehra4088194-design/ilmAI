  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card><CardContent className="p-5"><p className="text-xs text-muted-foreground mb-1">Assistant Tokens Today</p><p className="text-2xl font-bold">-</p></CardContent></Card>

...
export const APP_DESTINATIONS: AppDestination[] = [
  ...
  {
    label: 'Open Pairing Schemes',
    href: '/library?type=pairing_scheme',
    keywords: ['pairing scheme', 'paper scheme', 'assessment scheme'],
  },
  {
    label: 'Open Guess Papers',
    href: '/library?type=guess_paper',
    keywords: ['uploaded guess paper', 'guess papers', 'model guess paper'],
  },

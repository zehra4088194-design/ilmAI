...
export const APP_DESTINATIONS: AppDestination[] = [
  ...
  { label: 'Open Pairing Schemes', href: '/library?type=pairing_scheme', keywords: ['pairing scheme', 'paper scheme', 'assessment scheme'] },
  { label: 'Open Guess Papers', href: '/library?type=guess_paper', keywords: ['uploaded guess paper', 'guess papers', 'model guess paper'] },
  { label: 'Open AI Tutor', href: '/ai-tutor', keywords: ['ai tutor', 'tutor', 'teacher', 'samjhao'] },
  { label: 'Start Adaptive Practice', href: '/practice', keywords: ['practice', 'testing', 'test practice'] },
  ...
  { label: 'Open Applications', href: '/student-applications', keywords: ['application', 'applications', 'leave', 'sick leave', 'principal', 'class incharge', 'request'] },

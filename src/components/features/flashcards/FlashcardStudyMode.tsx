...
const RATINGS = [
  ...
  { key: 'good', label: 'Good', sub: '3 days', color: 'bg-emerald-500 hover:bg-emerald-400', ease: 0 },
  { key: 'easy', label: 'Easy', sub: '7 days', color: 'bg-sky-500 hover:bg-sky-400', ease: 0.15 },
] as const;

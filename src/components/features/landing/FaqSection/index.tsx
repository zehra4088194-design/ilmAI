...
const FAQS = [
  { q: 'ilm AI bilkul free hai?', a: 'Haan! Free plan mein notes/read mode free hai, side chat 5/day aur AI tools/testing 3/day preview milta hai. Zyada chahiye to Pro ya Elite plan lo.' },

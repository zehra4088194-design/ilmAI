  ...
  return (
    <>
      <motion.button
        ...
        className={cn(
          'fixed right-5 bottom-5 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 shadow-2xl shadow-violet-500/30',
          isOpen && 'hidden'
        )}
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <div className="border-border/80 bg-background/70 flex shrink-0 items-center gap-2 border-b p-3 backdrop-blur-xl">
              ...
              <div className="bg-background/55 flex-1 space-y-3 overflow-y-auto p-3 backdrop-blur-sm">
                {messages.length === 0 && (
              ...
              <div className="border-border/80 bg-background/90 flex shrink-0 items-center gap-2 border-t p-3 backdrop-blur-xl">
                <ScanUpload
